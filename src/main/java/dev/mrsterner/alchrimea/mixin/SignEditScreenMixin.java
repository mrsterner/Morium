...
public class SignEditScreenMixin {
    ...
    private SpriteIdentifier getSignTextureId(SpriteIdentifier spriteIdentifier) {
        if (sign.getCachedState().getBlock() instanceof CedarSign) {
            return new SpriteIdentifier(TexturedRenderLayers.SIGNS_ATLAS_TEXTURE, ((CedarSign) sign.getCachedState().getBlock()).getTexture());
        }
